...
export default function ForumPage() {
  ...
  const addSession = (event: GestureResponderEvent) => {
      ...
      <View style={styles.content}>
        <ScrollView>
          ...
          <View style={styles.tabs}>
            <TouchableOpacity style={styles.tab} onPress={() => router.push('/forumDisc')}>
              <Text style={styles.tabText}>Discussion</Text>
            </TouchableOpacity>
            <TouchableOpacity style={[styles.tab, styles.activeTab]}>
              <Text style={styles.activeTabText}>Session</Text>
            </TouchableOpacity>
          </View>
          {/* Session tab */}
